...
@EnableJpaRepositories(
        ...
        basePackages = {"cn.iocoder.springboot.lab17.dynamicdatasource.repository.pg"}) // 设置 Repository 接口所在包
//        basePackages = {"cn.iocoder.springboot.lab17.dynamicdatasource.repository.mysql"}) // 设置 Repository 接口所在包
public class JpaUsersConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("cn.iocoder.springboot.lab17.dynamicdatasource.dataobject.pg") // 数据库实体 entity 所在包
//                .packages("cn.iocoder.springboot.lab17.dynamicdatasource.dataobject.mysql") // 数据库实体 entity 所在包
